...
const noirForeground = Buffer.from(`
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1880">
    ...
    <g transform="translate(40 80)" font-family="Bahnschrift Condensed, Arial Narrow, Segoe UI, sans-serif">
      ...
      <text x="39" y="65" fill="#fff" fill-opacity=".66" font-size="14" font-weight="650" letter-spacing="2.2">ПОСЛЕДНИЙ ПОДПИСЧИК</text>
      <text x="39" y="108" fill="#fff" font-size="43" font-weight="650" letter-spacing="1.3" filter="url(#glow)">@anna_live</text>
      <line x1="39" y1="128" x2="470" y2="128" stroke="#fff" stroke-opacity=".8" filter="url(#glow)"/>
...
const noirWideForeground = Buffer.from(`
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1880">
    ...
    <g transform="translate(640 1320)" font-family="Bahnschrift Condensed, Arial Narrow, Segoe UI, sans-serif">
      <text x="31" y="126" fill="#fff" fill-opacity=".64" font-size="10" font-weight="600" letter-spacing="2">ПОСЛЕДНИЙ ПОДПИСЧИК</text>
      <text x="31" y="159" fill="#fff" font-size="32" font-weight="650" letter-spacing="1.2" filter="url(#wideGlow)">@anna_live</text>
