...
const animeForeground = Buffer.from(`
  <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="1260">
    ...
    <g transform="translate(40 80)" font-family="Segoe UI, Arial, sans-serif">
      <circle cx="99" cy="99" r="69" fill="url(#ring)"/>
      <circle cx="99" cy="99" r="60" fill="#192b50" stroke="#10203d" stroke-width="4"/>
      <text x="99" y="108" text-anchor="middle" fill="#fff" font-size="27" font-weight="700">АС</text>
      <rect x="188" y="61" width="294" height="62" rx="19" fill="#10254c" fill-opacity=".9" stroke="#8ee8ff" stroke-opacity=".24"/>
      <text x="206" y="101" fill="#fff" font-size="26" font-weight="720">Анна Смирнова</text>
    </g>
  </svg>
`);
